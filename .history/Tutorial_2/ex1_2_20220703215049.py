...
def question_n():
    arr_1 = np.random.randint(100, size=4)
    arr_2 = np.random.randint(100, size=4)

    print(arr_1)
    print(arr_2)
    array_vs = np.vstack((arr_1,arr_2))
    array_hs = np.hstack((arr_1,arr_2))

    
    print(array_vs)
    print(array_hs)

    print(np.array_split(array_vs,2))
    print(np.array_split(array_hs,2))
