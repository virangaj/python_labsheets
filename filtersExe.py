...
def custom_filters():
    location = r'Aug10/Sample_images/test_pattern_blurring_orig.tif'
...
def median_filter():
    location = r'Aug10/Sample_images/test_pattern_blurring_orig.tif'
    location_ = r'Aug10/Sample_images/ckt_board_saltpep.tif'
    img = cv2.imread(location, cv2.IMREAD_GRAYSCALE)
...
def bilateral_filter():
    location = r'Aug10/Sample_images/img_mri_brain_tumor.jpg'
    img = cv2.imread(location, cv2.IMREAD_GRAYSCALE)
...
def sobel_filter():
    location = r'Aug10/Sample_images/sudoku-original_clahe.jpg'
    img = cv2.imread(location, cv2.IMREAD_GRAYSCALE)
...
def unsharp_mask():
    location = r'Aug10/Sample_images/blurry_moon.tif'
    img = cv2.imread(location, cv2.IMREAD_GRAYSCALE)
...
def sobel_laplacian_canny():
    ...
    images = (img, laplacian, edges, grad_x, grad_y, grad_xy)
    title = ('original', 'laplacian', 'edges', 'sobel x', 'sobel y', 'sobel xy')
